...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Dumont Code failed to load",
  "desktop.recovery.terminated": "Dumont Code window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Dumont Code is not responding",
