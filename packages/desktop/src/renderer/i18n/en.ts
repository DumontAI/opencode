export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Dumont Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Dumont Code has been downloaded, would you like to install it and relaunch?",
